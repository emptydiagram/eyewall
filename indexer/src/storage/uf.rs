...
mod tests {
    ...
    use super::super::{BskyPostId, BskyPostRecord, BskyPostReplyTo};
    use super::{BskyPostUnionFind, SubgraphType};

    #[test]
    fn test_simple_reply_thread_1() {
        let mut uf = BskyPostUnionFind::new();

        let id1 = BskyPostId::new("a", "1");
        let id2 = BskyPostId::new("b", "1");
        let id3 = BskyPostId::new("a", "2");
        let id4 = BskyPostId::new("a", "3");
        ...
        uf.ingest_post(BskyPostRecord {
            id: id4.clone(),
            reply_to: Some(BskyPostReplyTo { target: id3.clone(), root: id1.clone() }),
            quote_of: None,
            created_at: None
        });
    ...
    fn test_simple_quote_chain() {
        ...
        let id3 = BskyPostId::new("a", "2");
        let id4 = BskyPostId::new("a", "3");
        let records: Vec<BskyPostRecord<_>> = vec![
            BskyPostRecord {
                id: id2.clone(),
                reply_to: None,
    ...
    fn test_reply_quote_graph() {
        let id1 = BskyPostId::new("a", "1");
        let id2 = BskyPostId::new("b", "1");
        let id3 = BskyPostId::new("c", "1");
        let id4 = BskyPostId::new("a", "2");
        let id5 = BskyPostId::new("a", "3");
        let id6 = BskyPostId::new("a", "4");
        let records: Vec<BskyPostRecord<_>> = vec![
            BskyPostRecord {
                id: id3.clone(),
                reply_to: Some(BskyPostReplyTo { target: id2.clone(), root: id1.clone() }),
